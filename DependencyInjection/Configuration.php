...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('sylius_categorizer');
                    ...
                    ->prototype('array')
                         ->children()
                            ...
                            ->arrayNode('templates')
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('frontend')->defaultValue('SyliusCategorizerBundle:Frontend/Category:%s.html.twig')->end()
                                    ->scalarNode('backend')->defaultValue('SyliusCategorizerBundle:Backend/Category:%s.html.twig')->end()
                                ->end()
                            ->end()
                        ->end()
                    ->end()
